...
**[v0.1.2](https://github.com/stoatworks-labs/animATEM/releases/tag/v0.1.2)** — prebuilt for macOS, Windows and Linux. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| x64 & ARM64 · .exe installer | [`animatem-0.1.2-setup.exe`](https://github.com/stoatworks-labs/animATEM/releases/download/v0.1.2/animatem-0.1.2-setup.exe) | 217 MB |
| x64 · .exe installer | [`animatem-0.1.2-x64-setup.exe`](https://github.com/stoatworks-labs/animATEM/releases/download/v0.1.2/animatem-0.1.2-x64-setup.exe) | 111 MB |
| ARM64 · .exe installer | [`animatem-0.1.2-arm64-setup.exe`](https://github.com/stoatworks-labs/animATEM/releases/download/v0.1.2/animatem-0.1.2-arm64-setup.exe) | 107 MB |
| x64 & ARM64 · portable .exe | [`animatem-0.1.2-portable.exe`](https://github.com/stoatworks-labs/animATEM/releases/download/v0.1.2/animatem-0.1.2-portable.exe) | 217 MB |
| x64 · portable .exe | [`animatem-0.1.2-x64-portable.exe`](https://github.com/stoatworks-labs/animATEM/releases/download/v0.1.2/animatem-0.1.2-x64-portable.exe) | 111 MB |
| ARM64 · portable .exe | [`animatem-0.1.2-arm64-portable.exe`](https://github.com/stoatworks-labs/animATEM/releases/download/v0.1.2/animatem-0.1.2-arm64-portable.exe) | 107 MB |
| x64 · .zip archive | [`animATEM-0.1.2-win.zip`](https://github.com/stoatworks-labs/animATEM/releases/download/v0.1.2/animATEM-0.1.2-win.zip) | 144 MB |
| ARM64 · .zip archive | [`animATEM-0.1.2-arm64-win.zip`](https://github.com/stoatworks-labs/animATEM/releases/download/v0.1.2/animATEM-0.1.2-arm64-win.zip) | 143 MB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .deb package (Debian/Ubuntu) | [`animatem_0.1.2_amd64.deb`](https://github.com/stoatworks-labs/animATEM/releases/download/v0.1.2/animatem_0.1.2_amd64.deb) | 96 MB |
| ARM64 · .deb package (Debian/Ubuntu) | [`animatem_0.1.2_arm64.deb`](https://github.com/stoatworks-labs/animATEM/releases/download/v0.1.2/animatem_0.1.2_arm64.deb) | 91 MB |
| x64 · .rpm package (Fedora/RHEL) | [`animatem-0.1.2.x86_64.rpm`](https://github.com/stoatworks-labs/animATEM/releases/download/v0.1.2/animatem-0.1.2.x86_64.rpm) | 85 MB |
| ARM64 · .rpm package (Fedora/RHEL) | [`animatem-0.1.2.aarch64.rpm`](https://github.com/stoatworks-labs/animATEM/releases/download/v0.1.2/animatem-0.1.2.aarch64.rpm) | 80 MB |
| x64 · AppImage | [`animATEM-0.1.2.AppImage`](https://github.com/stoatworks-labs/animATEM/releases/download/v0.1.2/animATEM-0.1.2.AppImage) | 123 MB |
| ARM64 · AppImage | [`animATEM-0.1.2-arm64.AppImage`](https://github.com/stoatworks-labs/animATEM/releases/download/v0.1.2/animATEM-0.1.2-arm64.AppImage) | 124 MB |
